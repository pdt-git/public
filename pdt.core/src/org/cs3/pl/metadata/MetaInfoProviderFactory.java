...
//TODO: Check if there is an additional implementation but org.cs3.pl.metadata.internal.classic.Factory.
//	    If not, merge it together and use it as a standard singleton.
public abstract class MetaInfoProviderFactory {
	...
	public static MetaInfoProviderFactory newInstance(){
		try{
			Class<?> impl = Class.forName(DEFAULT);
