...
wrap_term(Term,Positions,OutTerm):-
    compound(Term),
    !,
    Term=..[Functor|Args],
    ...
    pdt_term_annotation(OutTerm0,SubTerm,_),
    pdt_add_annotation(OutTerm0,position,From-To,OutTerm),
    wrap_args(Args,SubPositions,WrapedArgs).
wrap_term(Term,Positions,OutTerm):-
    \+ compound(Term),
    top_position(Positions, From,To),
    !,
    pdt_term_annotation(OutTerm0,Term,_),
    pdt_add_annotation(OutTerm0,position,From-To,OutTerm).    
wrap_term(Term,_,OutTerm):-
    \+ compound(Term),
    pdt_term_annotation(OutTerm0,Term,_),
    pdt_add_annotation(OutTerm0,implicit_nil,true,OutTerm).    
