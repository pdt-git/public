...
public class PrologWriter implements IPrologWriter {
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#setIndentionLevel(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#addIndention()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#reduceIndention()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#writeFact(java.lang.String,
     *           java.lang.String[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#writeRule(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#setInterpretMode(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#getInterpretMode()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#writeQuery(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#close()
     */
    public void close() {
       try {
        out.close();
     ...
     * (non-Javadoc)
     * 
     * @see org.cs3.jlmp.internal.astvisitor.IPrologWriter#flush()
     */
    public void flush() {
        try {
            out.flush();
