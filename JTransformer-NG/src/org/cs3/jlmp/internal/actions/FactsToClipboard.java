...
import org.cs3.jlmp.internal.astvisitor.SectionFactGenerator;
import org.cs3.jlmp.internal.astvisitor.VariableIdResolver;
import org.cs3.jlmp.internal.astvisitor.VariableTypeResolver;
import org.cs3.jlmp.internal.bytecode.ITypeFQNManager;
...
public void run(IAction action)  {
	...
	private void showError(final String msg) {
		final Shell shell = JLMPPlugin.getDefault().getWorkbench().getActiveWorkbenchWindow().getShell();
