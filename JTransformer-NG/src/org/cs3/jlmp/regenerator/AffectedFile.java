...
public class AffectedFile implements IAffectedFile {
	...
	/* 
	 * @see org.cs3.jlmp.regenerator.IAffectedType#getChangesStatus()
	 */
	...
	/* 
	 * @see org.cs3.jlmp.regenerator.IAffectedType#getFullyQualifiedName()
	 */
	...
	/* 
	 * @see org.cs3.jlmp.regenerator.IAffectedType#getTextChanges()
	 */
