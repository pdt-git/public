...
public class PreferencePage extends FieldEditorPreferencePage implements
    ...
    public PreferencePage() {
        super(GRID);
        setPreferenceStore(JTransformerPlugin.getDefault().getPreferenceStore());
        setDescription("Preferences for the JTransformer Plugin");
        //initializeDefaults();
    }
    ...
    protected void performDefaults() {
        //JTransformerPlugin.getDefault().updatePreferences();
