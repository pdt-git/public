...
% Date: 7.9.2004
 ...
 /*******************************************************************
  ...
  the internal representation of ASTs and to check correctness (of CTs
  and of the internal representation generated by a parser).
  ***************************************************************** */ 
...
/**
  ...
  *
  * These two definitions express the convention that  
  */
