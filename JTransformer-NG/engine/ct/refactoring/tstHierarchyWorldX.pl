...
toplevelT(100001, 100002, 'org/joint/exintexp/tstHierarchy/ILeft.java', [ileft]).

methodDefT(100004, ileft,'l',[100005],type(basic, 'void', 0),[],'null').
      varDefT(100005, 100004, 100004, type(basic, 'int', 0), 'i', 'null').
methodDefT(100006, ileft,'lt',[100007],type(basic, 'void', 0),[],'null').
      varDefT(100007, 100006, 100006, type(basic, 'int', 0), 'i', 'null').
methodDefT(100008, ileft,'lm',[100009],type(basic, 'void', 0),[],'null').
      varDefT(100009, 100008, 100008, type(basic, 'int', 0), 'i', 'null').
methodDefT(100010, ileft,'lb',[100011],type(basic, 'void', 0),[],'null').
      varDefT(100011, 100010, 100010, type(basic, 'int', 0), 'i', 'null').
methodDefT(100012, ileft,'ltmb',[100013],type(basic, 'void', 0),[],'null').
      varDefT(100013, 100012, 100012, type(basic, 'int', 0), 'i', 'null').
classDefT(ileft, 100002, 'ILeft', [100004, 100006, 100008, 100010, 100012]).
interfaceT(ileft).
   modifierT(ileft, 'public').
   extendsT(ileft, 100014).

consulted('org/joint/exintexp/tstHierarchy/ITop.pl').
toplevelT(100015, 100002, 'org/joint/exintexp/tstHierarchy/ITop.java', [itop]).

methodDefT(100017, itop,'t',[100018],type(basic, 'void', 0),[],'null').
      varDefT(100018, 100017, 100017, type(basic, 'int', 0), 'i', 'null').
methodDefT(100019, itop,'lt',[100020],type(basic, 'void', 0),[],'null').
      varDefT(100020, 100019, 100019, type(basic, 'int', 0), 'i', 'null').
methodDefT(100021, itop,'tb',[100022],type(basic, 'void', 0),[],'null').
      varDefT(100022, 100021, 100021, type(basic, 'int', 0), 'i', 'null').
methodDefT(100023, itop,'ltmb',[100024],type(basic, 'void', 0),[],'null').
      varDefT(100024, 100023, 100023, type(basic, 'int', 0), 'i', 'null').
classDefT(itop, 100002, 'ITop', [100017, 100019, 100021, 100023]).
interfaceT(itop).
   modifierT(itop, 'public').
   extendsT(itop, 100014).

consulted('org/joint/exintexp/tstHierarchy/IMiddle.pl').
toplevelT(100025, 100002, 'org/joint/exintexp/tstHierarchy/IMiddle.java', [imiddle]).

methodDefT(100027, imiddle,'m',[100028],type(basic, 'void', 0),[],'null').
      varDefT(100028, 100027, 100027, type(basic, 'int', 0), 'i', 'null').
methodDefT(100029, imiddle,'lm',[100030],type(basic, 'void', 0),[],'null').
      varDefT(100030, 100029, 100029, type(basic, 'int', 0), 'i', 'null').
methodDefT(100031, imiddle,'ltmb',[100032],type(basic, 'void', 0),[],'null').
      varDefT(100032, 100031, 100031, type(basic, 'int', 0), 'i', 'null').
methodDefT(100033, imiddle,'l',[100034, 100035],type(basic, 'void', 0),[],'null').
      varDefT(100034, 100033, 100033, type(basic, 'int', 0), 'i', 'null').
      varDefT(100035, 100033, 100033, type(basic, 'int', 0), 'j', 'null').
methodDefT(100036, imiddle,'tb',[100037, 100038],type(basic, 'void', 0),[],'null').
      varDefT(100037, 100036, 100036, type(basic, 'int', 0), 'i', 'null').
      varDefT(100038, 100036, 100036, type(basic, 'int', 0), 'j', 'null').
classDefT(imiddle, 100002, 'IMiddle', [100027, 100029, 100031, 100033, 100036]).
interfaceT(imiddle).
   modifierT(imiddle, 'public').
   extendsT(imiddle, 100014).
   implementsT(imiddle, itop).

consulted('org/joint/exintexp/tstHierarchy/IBottom.pl').
toplevelT(100039, 100002, 'org/joint/exintexp/tstHierarchy/IBottom.java', [ibottom]).

methodDefT(100041, ibottom,'b',[100042],type(basic, 'void', 0),[],'null').
      varDefT(100042, 100041, 100041, type(basic, 'int', 0), 'i', 'null').
methodDefT(100043, ibottom,'lb',[100044],type(basic, 'void', 0),[],'null').
      varDefT(100044, 100043, 100043, type(basic, 'int', 0), 'i', 'null').
methodDefT(100045, ibottom,'tb',[100046],type(basic, 'void', 0),[],'null').
      varDefT(100046, 100045, 100045, type(basic, 'int', 0), 'i', 'null').
methodDefT(100047, ibottom,'ltmb',[100048],type(basic, 'void', 0),[],'null').
      varDefT(100048, 100047, 100047, type(basic, 'int', 0), 'i', 'null').
classDefT(ibottom, 100002, 'IBottom', [100041, 100043, 100045, 100047]).
interfaceT(ibottom).
   modifierT(ibottom, 'public').
   extendsT(ibottom, 100014).
   implementsT(ibottom, imiddle).
   implementsT(ibottom, ileft).

consulted('org/joint/exintexp/tstHierarchy/TheClass.pl').
toplevelT(100049, 100002, 'org/joint/exintexp/tstHierarchy/TheClass.java', [theclass]).

methodDefT(100051, theclass,'<init>',[],type(basic, 'void', 0),[],100052).
...
methodDefT(100090, theclass,'l',[100091, 100092],type(basic, 'void', 0),[],100093).
...
methodDefT(100094, theclass,'<clinit>',[],type(basic, 'void', 0),[],100095).
   modifierT(100094, 'static').
   blockT(100095, 100094, 100094, []).
methodDefT(100096, theclass,'<clinit>',[],type(basic, 'void', 0),[],100097).
   blockT(100097, 100096, 100096, []).
classDefT(theclass, 100002, 'TheClass', [100051, 100056, 100059, 100062, 100065, 100068, 100071, 100074, 100077, 100080, 100083, 100086, 100090, 100094, 100096]).
   modifierT(theclass, 'public').
   extendsT(theclass, 100014).
   implementsT(theclass, ibottom).
   implementsT(theclass, ileft).
...
methodDefT(100105, 100099,'main',[100106],type(basic, 'void', 0),[],100107).
   ...
   blockT(100107, 100105, 100105, [100109, 100110, 100111, 100112, 100113, 100114, 100115, 100116, 100117, 100118, 100119, 100120, 100121]).
         newClassT(100123, 100109, 100105, 100051, [], 100122, 'null', null).
            identT(100122, 100123, 100105, 'TheClass', theclass).
         varDefT(100109, 100107, 100105, type(class, theclass, 0), 'myClass', 100123).
