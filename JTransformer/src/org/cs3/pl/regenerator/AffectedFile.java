...
public class AffectedFile implements IAffectedFile {
	...
	/* 
	 * @see org.cs3.pl.regenerator.IAffectedType#getChangesStatus()
	 */
	...
	/* 
	 * @see org.cs3.pl.regenerator.IAffectedType#getFullyQualifiedName()
	 */
	...
	/* 
	 * @see org.cs3.pl.regenerator.IAffectedType#getTextChanges()
	 */
