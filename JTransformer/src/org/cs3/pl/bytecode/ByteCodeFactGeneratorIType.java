 ...
 * 
 * @see org.cs3.pl.astvisitor.FactGenerator
 */
...
*/	
	 ...
	 * @param box
	 */
	public ByteCodeFactGeneratorIType(PrependablePrologWriter pwriter, String fqn2, IJavaProject javaProject, FactGenerationToolBox box) throws ClassNotFoundException, CoreException {
	...
	// via the JLMP Nature) so i changed the signiture of this constructor.
	public ByteCodeFactGeneratorIType(IProject project, PrependablePrologWriter pwriter, String classname, FactGenerationToolBox box) throws JavaModelException, CoreException, ClassNotFoundException {
