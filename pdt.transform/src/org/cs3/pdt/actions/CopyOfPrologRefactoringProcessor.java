...
public class CopyOfPrologRefactoringProcessor extends RefactoringProcessor {
	
	private final PrologRefactoringInfo info;

	public CopyOfPrologRefactoringProcessor(PrologRefactoringInfo info) {
		this.info = info;
	}
...
RefactoringStatus result = new RefactoringStatus();
	...
	public RefactoringStatus checkInitialConditions(IProgressMonitor pm)
		...
		//result.addFatalError("Mal sehen was passiert, wenn ich hier einen Fatalen Fehler einbaue");
