...
find_reference_to(Functor,Arity,_DefFile, SearchMod, ExactMatch,RefModule,RefName,RefArity,RefFile,Position,Nth,call,[goal(ReferencingGoalAsAtom)|PropertyList]) :-
