...
/**
 * This class provides constant property keys for all configurable properties
 * used by pdt and adjacent Projects
 */
public class Properties {
     ...
     * editor. 
     */
    public final static String CONSULT_PATH = "pdt.consult.path";

    public final static String CONSULT_RECURSIVE = "pdt.consult.recursive";

    /**
     * An absolute os file system path to the directory containing the prolog files of the
     * pdt metadata engine.
     */
    public final static String METADATA_ENGINE_DIR = "pdt.metadata.engine.dir";
    
    /**
     * An absolute os file system path to the directory containing the prolog files of the
     * jtransformer engine.
     */
    public final static String JTRANSFORMER_ENGINE_DIR = "jtransformer.engine.dir";
     ...
     */
    public final static String SWIPL_DIR = "pdt.swipl.dir";

    /**
     * the port on which the RaPlaRPC server is listening.
     */
    public static final String SERVER_PORT = "pdt.server.port";

    /**
     * the port on which the prolog console server is listening.
     */
    public static final String CONSOLE_PORT = "pdt.console.port";
     ...
     */
    public final static String SERVER_STANDALONE = "pdt.server.standalone";
     ...
     */
    public static final String USE_SESSION_POOLING = "pdt.use.session.pooling";
     ...
     */
    public final static String DEBUG_LEVEL = "debug.level";
     ...
     */
    public final static String SERVER_CLASSPATH = "pdt.server.classpath";
}