...
public class PDTPrologHelper implements IMetaInfoProvider {
    private static final boolean windowsPlattform = System.getProperty(
    ...
    public PDTPrologHelper(PrologInterface prologInterface,
            String pdtModulePrefix) {
    ...
    public SourceLocation getLocation(String functor, int arity, String filename)
        ...
        if (location.file.startsWith("'")) {
            location.file = location.file.substring(1,
                    location.file.length() - 1);
        }
        return location;
     ...
     */
    public PrologElementData[] getPredicatesWithPrefix(String module,
            String prefix, String filename) throws NumberFormatException,
            PrologException {
        //return
