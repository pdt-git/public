...
public class PreferenceConstants {
	...
	public static final String PREDICATE_VISIBILITY_PDT_PREDICATES = "PREDICATE_VISIBILITY_PDT_PREDICATES";
	
	public static final String PREDICATE_VISIBILITY_PDT_METAPREDICATES = "PREDICATE_VISIBILITY_PDT_METAPREDICATES";
	
	public static final String PREDICATE_VISIBILITY_SWI_PREDICATES = "PREDICATE_VISIBILITY_SWI_PREDICATES";
	
	public static final String PREDICATE_VISIBILITY_SWI_METAPREDICATES = "PREDICATE_VISIBILITY_SWI_METAPREDICATES";
}
