...
//                  clear buffer
                ...
                case '>':
                    ...
                    //otherwise, the value is elem of the list lying on top of the stack.
                    if(stack.isEmpty()){
                        return value;
                    }
                    else{
                ...
                case '}':
                    ...
                    if(stack.isEmpty()){                       
                        throw new PrologException("Read a closing curly bracket (']') but there is no containing list!");
                    }
