...
public class DependenciesGraphPIFLoader extends GlobalGraphPIFLoader {
	...
	protected String generateQuery(File helpFile) {
		try {
			...
			String query;
			query = bT(PDTGraphPredicates.WRITE_DEPENDENCIES_TO_GRAPHML, paths.toString(), QueryUtils.quoteAtom(projectPath), QueryUtils.quoteAtom(QueryUtils.prologFileName(helpFile)));
			return query;
